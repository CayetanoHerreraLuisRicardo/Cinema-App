...
namespace AppStudio
{
    ...
    {
        private Guid APP_ID = new Guid("7665e478-28e0-4a38-b5a5-cf3dfe1f846f");
        public const string APP_NAME = "Cinem-App";
        ...
        {
            TileServices.CreateIconicTile(@"Todo lo relacionado al Cine", @"Noticias, Estrenos, Prox.", @"");
        }
        #endregion
    }
}
