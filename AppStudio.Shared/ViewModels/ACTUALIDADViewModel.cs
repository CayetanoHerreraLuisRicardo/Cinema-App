...
{
    public class ACTUALIDADViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("ACTUALIDADDetail", item);
                        });
                }
        ...
        {
            return new ACTUALIDADDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("ACTUALIDADList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("ACTUALIDADDetail");
        }
    }
}
