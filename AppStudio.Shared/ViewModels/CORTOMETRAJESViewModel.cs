...
{
    public class CORTOMETRAJESViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("CORTOMETRAJESDetail", item);
                        });
                }
        ...
        {
            return new CORTOMETRAJESDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("CORTOMETRAJESList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("CORTOMETRAJESDetail");
        }
    }
}
