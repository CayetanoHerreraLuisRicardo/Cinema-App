...
{
    public class CRITICASViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("CRITICASDetail", item);
                        });
                }
        ...
        {
            return new CRITICASDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("CRITICASList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("CRITICASDetail");
        }
    }
}
