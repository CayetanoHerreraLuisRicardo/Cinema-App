...
{
    public class ELSEPTIMOARTEViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("ELSEPTIMOARTEDetail", item);
                        });
                }
        ...
        {
            return new ELSEPTIMOARTEDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("ELSEPTIMOARTEList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("ELSEPTIMOARTEDetail");
        }
    }
}
