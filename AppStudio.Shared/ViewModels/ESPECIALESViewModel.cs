...
{
    public class ESPECIALESViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("ESPECIALESDetail", item);
                        });
                }
        ...
        {
            return new ESPECIALESDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("ESPECIALESList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("ESPECIALESDetail");
        }
    }
}
