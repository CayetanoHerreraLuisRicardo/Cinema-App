...
{
    public class ESTRENOSDELASEMANAViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("ESTRENOSDELASEMANADetail", item);
                        });
                }
        ...
        {
            return new ESTRENOSDELASEMANADataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("ESTRENOSDELASEMANAList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("ESTRENOSDELASEMANADetail");
        }
    }
}
