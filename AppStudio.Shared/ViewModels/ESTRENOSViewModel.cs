...
{
    public class ESTRENOSViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("ESTRENOSDetail", item);
                        });
                }
        ...
        {
            return new ESTRENOSDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("ESTRENOSList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("ESTRENOSDetail");
        }
    }
}
