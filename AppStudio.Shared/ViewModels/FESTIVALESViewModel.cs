...
{
    public class FESTIVALESViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("FESTIVALESDetail", item);
                        });
                }
        ...
        {
            return new FESTIVALESDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("FESTIVALESList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("FESTIVALESDetail");
        }
    }
}
