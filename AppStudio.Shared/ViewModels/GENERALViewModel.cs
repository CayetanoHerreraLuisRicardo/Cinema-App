...
{
    public class GENERALViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("GENERALDetail", item);
                        });
                }
        ...
        {
            return new GENERALDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("GENERALList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("GENERALDetail");
        }
    }
}
