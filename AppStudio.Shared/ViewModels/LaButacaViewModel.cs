...
{
    public class LaButacaViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("LaButacaDetail", item);
                        });
                }
        ...
        {
            return new LaButacaDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("LaButacaList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("LaButacaDetail");
        }
    }
}
