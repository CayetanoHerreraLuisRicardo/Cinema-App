...
{
    public class NOTICIASDELCINEViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("NOTICIASDELCINEDetail", item);
                        });
                }
        ...
        {
            return new NOTICIASDELCINEDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("NOTICIASDELCINEList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("NOTICIASDELCINEDetail");
        }
    }
}
