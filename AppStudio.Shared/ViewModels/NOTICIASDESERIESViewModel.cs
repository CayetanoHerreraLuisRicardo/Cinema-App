...
{
    public class NOTICIASDESERIESViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("NOTICIASDESERIESDetail", item);
                        });
                }
        ...
        {
            return new NOTICIASDESERIESDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("NOTICIASDESERIESList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("NOTICIASDESERIESDetail");
        }
    }
}
