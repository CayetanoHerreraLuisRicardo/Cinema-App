...
{
    public class PELICULASENCARTELERAViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("PELICULASENCARTELERADetail", item);
                        });
                }
        ...
        {
            return new PELICULASENCARTELERADataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("PELICULASENCARTELERAList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("PELICULASENCARTELERADetail");
        }
    }
}
