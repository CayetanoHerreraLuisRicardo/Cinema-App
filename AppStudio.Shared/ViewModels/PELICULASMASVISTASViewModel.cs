...
{
    public class PELICULASMASVISTASViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("PELICULASMASVISTASDetail", item);
                        });
                }
        ...
        {
            return new PELICULASMASVISTASDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("PELICULASMASVISTASList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("PELICULASMASVISTASDetail");
        }
    }
}
