...
{
    public class PROXIMOSESTRENOSViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("PROXIMOSESTRENOSDetail", item);
                        });
                }
        ...
        {
            return new PROXIMOSESTRENOSDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("PROXIMOSESTRENOSList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("PROXIMOSESTRENOSDetail");
        }
    }
}
