...
{
    public class SERIESMASVISTASViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("SERIESMASVISTASDetail", item);
                        });
                }
        ...
        {
            return new SERIESMASVISTASDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("SERIESMASVISTASList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("SERIESMASVISTASDetail");
        }
    }
}
