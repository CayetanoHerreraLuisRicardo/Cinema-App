...
{
    public class TOPCRITICASESPECTADORESViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("TOPCRITICASESPECTADORESDetail", item);
                        });
                }
        ...
        {
            return new TOPCRITICASESPECTADORESDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("TOPCRITICASESPECTADORESList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("TOPCRITICASESPECTADORESDetail");
        }
    }
}
