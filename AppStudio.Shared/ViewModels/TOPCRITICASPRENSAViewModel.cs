...
{
    public class TOPCRITICASPRENSAViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("TOPCRITICASPRENSADetail", item);
                        });
                }
        ...
        {
            return new TOPCRITICASPRENSADataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("TOPCRITICASPRENSAList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("TOPCRITICASPRENSADetail");
        }
    }
}
